...
import 'fa_analysis_details_widget.dart';

class FAPersonalityAnalysisWidget extends StatelessWidget {
  const FAPersonalityAnalysisWidget({super.key});
