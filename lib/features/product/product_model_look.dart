...
ProductModelLook productModelLookFromJson(String str) => ProductModelLook.fromJson(json.decode(str));

String productModelLookToJson(ProductModelLook data) => json.encode(data.toJson());

class ProductModelLook {
    List<Item>? items;
    ...
    factory ProductModelLook.fromJson(Map<String, dynamic> json) => ProductModelLook(
