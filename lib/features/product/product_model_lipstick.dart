...
ProductModelLip productModelLipFromJson(String str) => ProductModelLip.fromJson(json.decode(str));

String productModelLipToJson(ProductModelLip data) => json.encode(data.toJson());

class ProductModelLip {
    List<Item>? items;
    ...
    factory ProductModelLip.fromJson(Map<String, dynamic> json) => ProductModelLip(
