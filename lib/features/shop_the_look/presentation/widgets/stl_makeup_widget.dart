...
class STLMakeupWidget extends StatefulWidget {
  final Function() onProductsList;

  const STLMakeupWidget({
    super.key,
    required this.onProductsList,
  });

  @override
  State<STLMakeupWidget> createState() => _STLMakeupWidgetState();
}

class _STLMakeupWidgetState extends State<STLMakeupWidget> {
